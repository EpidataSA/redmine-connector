    ...
    extends NamespaceHandlerSupport
{
    ...
    private void handleException(String beanName, String beanScope, NoClassDefFoundError noClassDefFoundError) {
        ...
        logger.error(((((("Cannot launch the mule app, the  "+ beanScope)+" [")+ beanName)+"] within the ***REMOVED*** [redmine] is not supported in mule ")+ muleVersion));
        throw new FatalBeanException(((((("Cannot launch the mule app, the  "+ beanScope)+" [")+ beanName)+"] within the ***REMOVED*** [redmine] is not supported in mule ")+ muleVersion), noClassDefFoundError);
    }
